...
A partir del 31 de julio de 2026, la funcionalidad de SOAP se habrá eliminado.
Use la [API de REST](rest-api/list-of-standard-fields.md) para comunicarse con Marketo.
