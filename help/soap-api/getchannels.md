...
title: "getChannels"
feature: SOAP
description: "getChannels llamadas SOAP"
...
Esta función recupera la siguiente información sobre un canal configurado en Marketo:

- Estados de progresión
- Número de paso de cada estado de progresión
- Si un estado de progresión específico se ha definido como éxito

Puede obtener información sobre todos los canales o especificar una lista específica de canales

## Solicitud

| Nombre del campo | Obligatorio/Opcional | Descripción |
| --- | --- | --- |
| tag->values->stringItem | opcional | Lista de canales que desea consultar. If `<tag>` se omite, recibirá información sobre todos los canales |
