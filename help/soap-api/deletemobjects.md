...
feature: SOAP
description: SOAP llamadas a deleteMObjects de
...
Elimina uno o más [MObjects](marketo-objects.md) y devuelve el resultado de la operación (DELETED, UNCHANGED, FAILED).
