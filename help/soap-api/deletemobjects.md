...
feature: SOAP
description: "deleteMObjects llamadas SOAP"
...
Elimina una o más [MObjects](marketo-objects.md) y devuelve el resultado de la operación (DELETED, UNCHANGED, FAILED).
