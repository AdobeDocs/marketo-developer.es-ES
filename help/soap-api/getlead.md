...
title: getLead
feature: SOAP
description: llamadas a getLead SOAP
...
Esta función recupera un único registro de posibles clientes de Marketo, con todos los valores de campo de los campos integrados y personalizados, para un posible cliente identificado por la clave proporcionada (LeadKey). Si el posible cliente existe en función de los parámetros de entrada, los atributos del registro de posible cliente se devolverán en el resultado.

NOTA: Los atributos del posible cliente que son del tipo de datos de cadena y están vacíos no se devolverán como parte de la respuesta.
