...
La API de Marketo Engage SOAP se retirará después del 31 de enero de 2026. Todas las integraciones existentes que usan la API de SOAP deben retirarse o migrarse a la [API de REST de Marketo Engage](https://experienceleague.adobe.com/es/docs/marketo-developer/marketo/rest/rest-api) en esta fecha para evitar interrupciones en el servicio.
