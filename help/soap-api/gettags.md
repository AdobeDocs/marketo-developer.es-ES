...
title: getTags
feature: SOAP, Tags
description: Marketo SOAP getTags recupera tipos y valores de etiquetas que no son de canal con filtros de etiqueta opcionales, además de campos de solicitud y ejemplos de respuesta de solicitud XML completa.
...
Esta función recupera la siguiente información sobre las etiquetas que no son de canal configuradas en Marketo.

- Tipo de etiqueta
- Valor de etiqueta

Puede obtener información sobre todas las etiquetas que no sean de canal o especificar una lista específica de etiquetas o valores.
