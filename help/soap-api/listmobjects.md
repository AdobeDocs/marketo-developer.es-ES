...
title: listMObjects
feature: SOAP
description: Referencia para la llamada de SOAP listMObjects que devuelve nombres de objeto Marketo para descriptionMObjects, con XML de solicitud y respuesta y código de ejemplo.
...
Esta función devuelve los nombres de los objetos Marketo que pueden utilizarse como entrada en la función [describeMObjects](./describemobject.md) para las operaciones de detección de esquemas.

## Solicitud

_No hay entradas para esta API_
