...
feature: SOAP
description: Utilice getLeadActivity SOAP para recuperar el historial de actividades de posibles clientes por clave, filtrar tipos de actividades, establecer el tamaño del lote y paginar mediante la posición del flujo con ejemplos XML.
