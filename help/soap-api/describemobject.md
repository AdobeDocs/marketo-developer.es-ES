...
feature: SOAP
description: Aprenda a utilizar descriptionMObject en Marketo SOAP para recuperar metadatos y atributos de campo para ActivityRecord, LeadRecord, Opportunity y OpportunityPersonRole.
...
Esta función devuelve los metadatos de los objetos MObject estándar y virtual. Toma el objeto Marketo como entrada y devuelve los atributos de campo asociados a ese objeto.
