...
description: Llamadas de SOAP deleteCustomObjects.
...
Elimina uno o más objetos personalizados y devuelve el resultado de la operación (DELETED, UNCHANGED, FAILED).
