...
title: "mergeLeads"
feature: SOAP
description: "mergeLeads llamadas SOAP"
...
Acepta la clave de un posible cliente ganador y múltiples claves de un posible cliente perdedor para realizar una operación de combinación. Devuelve el ID de los posibles clientes y el estado.

## Solicitud

| Nombre del campo | Obligatorio/Opcional | Descripción |
| --- | --- | --- |
| winningLeadKeyList | Obligatorio | La clave utilizada para identificar al posible cliente ganador. Los valores posibles son: `IDNUM`, `EMAIL`, `SFDCLEADID`, `LEADOWNEREMAIL`, `SFDCACCOUNTID`, `SFDCCONTACTID`, `SFDCLEADID`, `SFDCLEADOWNERID`, `SFDCOPPTYID` |
| lossLeadKeyLists | Obligatorio | Una lista de claves utilizada para identificar los posibles clientes perdedores. |
| mergeInSales | opcional | Pasado como booleano, como &quot;True&quot; o &quot;False&quot; |
