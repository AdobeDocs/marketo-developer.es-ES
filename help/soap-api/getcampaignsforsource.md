...
feature: SOAP
description: SOAP llamadas a getCampaignsForSource
...
| --- | --- | --- |
| origen | Obligatorio | el origen puede ser `MKTOWS` o `SALES`. Este último proporciona una lista de campañas disponibles para Sales Insight. |
