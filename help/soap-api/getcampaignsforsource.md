...
feature: SOAP
description: Marketo SOAP getCampaignsForSource devuelve campañas inteligentes aptas por fuente para requestCampaign, requiere que Campaign se solicite en los ejemplos de déclencheur, XML y PHP.
...
Esta función devuelve una lista de campañas de Marketo aptas que pueden utilizarse como parámetros de entrada en la función requestCampaign. Las campañas se clasifican por el origen de la solicitud, que se cuenta en el WSDL.

Importante: La campaña inteligente debe tener el déclencheur &quot;Se solicita la campaña&quot; para poder optar a ella. Su origen debe incluir la API de servicio web.

![campaign_is_requested_déclencheur](assets/campaign-is-requested-trigger.png)

## Solicitud

| Nombre del campo | Obligatorio/Opcional | Descripción |
| --- | --- | --- |
| origen | Obligatorio | el origen puede ser `MKTOWS` o `SALES`. Esta última proporciona una lista de campañas disponibles para Sales Insight. |
| name | Opcional | utilice esta opción para filtrar por nombre. Es una sola cadena, no una matriz de cadenas. |
| exactaNombre | Opcional | Valor booleano que indica si desea una coincidencia exacta para el parámetro name |
