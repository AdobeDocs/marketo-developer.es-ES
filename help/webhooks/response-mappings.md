...
feature: Webhooks
description: Asignaciones de respuestas de Webhooks de Marketo para JSON y XML, asignación de atributos a campos de posibles clientes, notación de puntos y matrices y compatibilidad de tipos.
...
Marketo puede traducir datos de ganchos web de JSON o XML y escribir los valores en campos de posibles clientes. El parámetro Campo de Marketo siempre utiliza el nombre de API de SOAP del campo.
